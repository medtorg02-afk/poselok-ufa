...
function FAQBlock() {
  const FAQ = [
    { q: "Сколько стоят дома в КП Карповский?", a: "Дома площадью 121–123 м² — от 11 700 000 ₽, 142 м² — 12 400 000 ₽, 158 м² — 13 100 000 ₽. Цены актуальны на 2026 год. Доступна бесплатная бронь на 4 дня для фиксации цены. Бронь на месяц — 100 000 ₽, которые идут в счёт оплаты." },
